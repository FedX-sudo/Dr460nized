...
def create_screen(args):
    ...
    if args.draw_console:
        ...
        args.x_quit = screen.blit(args.x_quit_img, [1230, 5])
        args.console_text_r = font.render(args.console_text, True, (255, 255, 255))
        args.screen.blit(args.console_text_r, [10, 50])

        args.console_output_text_r = font.render(args.console_output_text, True, (255, 255, 255))
    ...
    if (args.draw_chrome):
        ...
        pygame.draw.rect(args.screen, (220, 220, 220), pygame.Rect(0, 0, 1280, 40))
        x_quit = screen.blit(args.x_quit_img, [1230, 5])
